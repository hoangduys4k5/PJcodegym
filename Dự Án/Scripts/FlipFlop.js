...
function init() { 
    ...
    gameOn = true;
     ...
     blockFrontImages = ["Images/sp6.jpeg",
        "Images/sp4.jpg",
        "Images/sp3.jpg",
        "Images/sp5.jpg",
        "Images/sp1.jpeg",
...
function createElements() {
    ...
    for (var i = 0; i < finalCount; i++) {
        ...
        blockData = new MemoryBlock(i, cardFront, "Images/logo.png");
...
function thoatgame(){
     window.location.replace("DUANCAPHE.html");
}
